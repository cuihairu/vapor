...
### 当前基线（2026-09-23，行覆盖 100.0% / 分支覆盖 99.9%）
...
| Steam.Core | 100.0%（取消/竞态臂经确定性测试与排除定性收尾，见下） | 99.9% (3004/3007) |
...
| **合计** | **100.0%** (15883/15883) | **99.9%** (6133/6137) |

分支覆盖门禁：CI `--min-branch 99.93`（基线 6133/6137 的未舍入值为 99.9348%，门禁取 99.93——当前过、丢一个条件 99.9185% 即红；2026-09-23 分支缺口冲刺第十一轮后设点，百分比一律工具计算）。行覆盖 100% 不蕴含分支覆盖 100%：一行执行过不等于它的每个布尔子条件结果都被取到。
