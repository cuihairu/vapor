...
│   └── Performance/                      并发与压力
├── Vapor.ControlPlane.Tests/             (670 tests)
...
| **合计** | **2542** | (2026-09-20 基线;另 E2E 以真实子进程覆盖 Agent 主循环,单测统计测不到) |
